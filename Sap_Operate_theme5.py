...
from PyQt5.QtWidgets import QApplication, QFileDialog, QMainWindow, QMessageBox, QAction
...
from theme_manager_theme5 import ThemeManager
...
class MyMainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.actionBlueTheme = QAction("Blue Theme", self)
        self.actionGreenTheme = QAction("Green Theme", self)
        self.actionPurpleTheme = QAction("Purple Theme", self)

        # Add theme actions to menu
        themeMenu = self.menubar.addMenu("Theme")
        themeMenu.addAction(self.actionLightTheme)
        themeMenu.addAction(self.actionDarkTheme)
        themeMenu.addAction(self.actionBlueTheme)
        themeMenu.addAction(self.actionGreenTheme)
        themeMenu.addAction(self.actionPurpleTheme)

        # Connect theme actions
        self.actionLightTheme.triggered.connect(lambda: self.theme_manager.set_theme("light"))
        self.actionDarkTheme.triggered.connect(lambda: self.theme_manager.set_theme("dark"))
        self.actionBlueTheme.triggered.connect(lambda: self.theme_manager.set_theme("blue"))
        self.actionGreenTheme.triggered.connect(lambda: self.theme_manager.set_theme("green"))
        self.actionPurpleTheme.triggered.connect(lambda: self.theme_manager.set_theme("purple"))
